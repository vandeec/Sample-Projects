...
public class MoPubUnityEditor : MoPubBase
{
    ...
    /// See <see cref="MoPubManager.OnSdkInitalizedEvent"/> for resulting triggered event.
    /// <para>
    /// For platform-specific implementations, see
    ...
    /// See <see cref="MoPubManager.OnSdkInitalizedEvent"/> for the resulting triggered event.
    /// <para>
    /// For platform-specific implementations, see
    /// MoPubAndroid.<see cref="MoPubAndroid.InitializeSdk(string)"/> and
    /// MoPubiOS.<see cref="MoPubiOS.InitializeSdk(string)"/>.
    ...
    /// <para>
    /// For platform-specific implementations, see
    /// MoPubAndroid.<see cref="MoPubAndroid.IsConsentDialogLoaded"/> and
    /// MoPubiOS.<see cref="MoPubiOS.IsConsentDialogLoaded"/>.
    /// </para>
    /// </summary>
    public static bool IsConsentDialogLoaded { get; /* Testing: */ set; }
